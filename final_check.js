...
async function main() {
  await execSQL('Final Check', `
    TRUNCATE TABLE temp_logs;
    INSERT INTO temp_logs (msg)
    SELECT 'TOTAL SEGUIMIENTOS: ' || COUNT(*) FROM public.seguimientos_fidelizacion;
    
    INSERT INTO temp_logs (msg)
    SELECT 'LISTA: ' || whatsapp FROM public.seguimientos_fidelizacion LIMIT 10;
  `);
}
