...
async function main() {
  await execSQL('Check State', `
    TRUNCATE TABLE temp_logs;
    INSERT INTO temp_logs (msg)
    SELECT 'INST: ' || i.whatsapp || ' | SEG_ID: ' || i.seguimiento_id || ' | STATE: ' || s.estado_tarea
    FROM interacciones i
    JOIN seguimientos_fidelizacion s ON i.seguimiento_id = s.id
    WHERE i.created_at >= '2026-04-17';
  `);
}
