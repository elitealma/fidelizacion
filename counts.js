...
async function main() {
  await execSQL('Counts', `
    TRUNCATE TABLE temp_logs;
    INSERT INTO temp_logs (msg)
    SELECT 'CLIENTS COUNT: ' || COUNT(*) FROM public.clientes;
    INSERT INTO temp_logs (msg)
    SELECT 'PEDIDOS COUNT: ' || COUNT(*) FROM public.pedidos;
    INSERT INTO temp_logs (msg)
    SELECT 'SEGUIMIENTOS COUNT: ' || COUNT(*) FROM public.seguimientos_fidelizacion;
  `);
}
