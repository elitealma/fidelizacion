...
async function main() {
  await execSQL('Nullability Check', `
    TRUNCATE TABLE temp_logs;
    INSERT INTO temp_logs (msg)
    SELECT column_name || ' is_nullable=' || is_nullable
    FROM information_schema.columns
    WHERE table_name = 'seguimientos_fidelizacion' AND column_name IN ('pedido_id', 'asesor_id');
  `);
}
